<template>
    <main>
        ...
        <div class="scroll-top" ref="scrollToTop" @click="scrollToTop()">
            <i class="fas fa-chevron-up"></i>
        </div>
        <div class="right-buttons">
            <div class="demos square-btn">
                <div class="icon">
                    <svg class="fss-before" width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    mounted() {
        window.addEventListener('scroll', () => {
            if (window.scrollY < 200) {
                this.$refs.scrollToTop.style.opacity = '0';
            } else this.$refs.scrollToTop.style.opacity = '1';
        })
    }
}
</script>
...
.right-buttons {
    ...
    .square-btn {
        ...
        box-shadow: 0 0 2rem rgba(50,50,50,0.4);
        margin-bottom: .5rem;
        cursor: pointer;
        text-align: center;
        display: flex;
